 ...
 * @author deepak
 */
public class FacAdPage1 extends javax.swing.JPanel {
	...
	/** Creates new form FacAdPage1 */
    public FacAdPage1(PageListener pageListener, MainFrame mainFrame) {
        ...
        initComponents();
        	...
        	new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					FacAdPage1.this.mainFrame.remove(FacAdPage1.this);
					FacAdPage1.this.mainFrame.facAdPage2.setSem(teacherID);
					FacAdPage1.this.mainFrame.add(FacAdPage1.this.mainFrame.facAdPage2);
					FacAdPage1.this.mainFrame.pack();
				}
        	});
